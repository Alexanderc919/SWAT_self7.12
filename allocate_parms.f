...
!      allocate (hqd(nstep*3+1))  !! was 73, changed for urban
  ...
  !!    allocate (uh(msub,49))
      ...
      allocate (sub_crain(10,msub))
	allocate (sub_sftmp_accu(10,msub))
      allocate (sub_smtmp(10,msub))
      allocate (sub_Elesnoline(10,msub))
      
      allocate (sub_CT(10,msub))
      allocate (sub_icefmx(10,msub))
      allocate (sub_icefmn(10,msub))
      
      allocate (sub_smtmp_accu(10,msub))
...
!      allocate (hhsubp(mhru,24))
 ...
 !     allocate (rhrbsb(24))
      ...
      allocate (iceeb(10,mhru))
      allocate (orig_iceeb(10,mhru))
...
!!    LID general
	...
	allocate(rspc_a(mhru))	
      allocate(snom_hru(3))!放3个变量的数组，hru尺度,日尺度
      allocate(snom_sub(msub,3))!放3个变量的数组，sub尺度,日尺度
      allocate(snom_hru1(mhru,3))!放3个变量的数组，hru尺度,月尺度
      allocate(snom_sub1(msub,3))!放3个变量的数组，sub尺度,月尺度   
