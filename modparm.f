...
!! septic variables for output.std
      ...
      real :: basminpf, basorgpf, sftmp,crain,smtmp,smfmx, smfmn, wgpq 
      
      real :: Elesnoline,CT,icefmx, icefmn,icemlt
      
      !!ÃÌº”¡Àsftmp_max, sftmp_accu, smtmp_accu
      real ::  sftmp_accu, smtmp_accu 
...
!!  added for binary files 3/25/09 gsm
      ...
      real, dimension (:,:), allocatable :: sub_icefmx, sub_icefmn
...
! msub = max number of subbasins
      ...
      real, dimension (:,:), allocatable ::sub_Elesnoline,sub_crain
      
      real, dimension (:,:), allocatable ::sub_CT
      
      real, dimension (:,:), allocatable :: sub_smtmp_accu
      real, dimension (:,:), allocatable :: sub_sftmp_accu
...
!    Drainmod tile equations  01/2006
      ...
      real, dimension (:,:), allocatable :: iceeb,orig_iceeb
      
      
      real, dimension (:,:), allocatable :: nsetlw,snotmpeb,bss,surf_bs  
      real, dimension (:,:), allocatable :: tmxband,tmaband,nsetlp
...
!! By Zhang for C/N cycling
	...
	real, dimension(:), allocatable :: sedc_a, surfqc_a, latc_a, 
     ...
     &  soc_a, rspc_a	
      ...
      real, dimension(:), allocatable :: snom_hru
      real, dimension(:,:), allocatable ::snom_sub,snom_sub1,snom_hru1
