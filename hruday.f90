...
!!    added for binary files 3/25/09 gsm line below and write (33333
     ...
     &      (pdvas(ii), ii = 1, mhruo), iyr
      ...
      !!output carbon related variables
      !!=================================
        write(414,999)cropname, j, subnum(j),             &
     &      hruno(j), (snom_hru(ii),ii=1,3)  !!fix_here

      return
999   format (a4,i5,1x,a5,a4,10x,f20.5,10x,f20.5,10x,f20.5)       !!fix_here     
1000  format (a4,i5,1x,a5,a4,i5,1x,i4,1x,i4,10x,f20.5,10x,f20.5,10x,f20.5)  
