...
!         end select
      ...
      write(416,1005)cropname, j, subnum(j), 
     &   (snom_hru1(j,ii),ii=1,3)
      end do

      return
1005  format (a4,i5,1x,a5,10x,f20.5,10x,f20.5,10x,f20.5)     
 1000 format (a4,i5,1x,a5,a4,i5,1x,e10.5,66f10.3,1x,
